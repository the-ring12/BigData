...
public class InverterPowerDriver {

    public void driver(String start, String stop, String plant, String inverter) {
        try {
//
//        /**
...
//        reduce.setStop(stop);
            ...
            */
            ...
            job.setJarByClass(InverterPowerDriver.class);
            ...
            */
            ...
            job.setMapperClass(InverterPowerMap.class);
            job.setMapOutputKeyClass(Text.class);
            job.setMapOutputValueClass(DoubleWritable.class);

            job.setReducerClass(InverterPowerReduce.class);
            job.setOutputKeyClass(Text.class);
            job.setOutputValueClass(DoubleWritable.class);

            FileInputFormat.addInputPath(job, new Path("/data/"+ plant+"_Generation_Data.csv"));
            FileOutputFormat.setOutputPath(job, new Path("/result/result6"));
